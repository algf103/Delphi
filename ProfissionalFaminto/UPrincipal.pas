...
type
  ...
  private
    ...
    IntervTempo:String;       // Tempo para avanço do relógio
    IntervAdDia:String;       // Tempo de verificação para avanço da semana
    IntervIniVot:String;      // Horário para o início da votação
    IntervFimVot:String;      // Horário para o fim da votação

    Sessao:recSessao;         // Controle da Sessão do Usuário

    LstUsuarios:array [1..TotUsuarios] of recCategUsuario;              // Usuários cadastrados
    LstVencedores:array of recVencedor;                                 // Restaurantes vencedores
    recRefeicao:array [1..TotTipRef] of recTipRefeicao;                 // Tipos de Refeições Disponíveis

    function VerLiberVotacao():Boolean;                                 // Verifica se está liberada a votação
    function VerPermisUsuario(Login:String;Senha:String):tpCodAutent;   // Verifica se o usuário já votou
    ...
    procedure BloqueiaUsuario(Login:String);                                 // Bloqueia usuário que já votou
    procedure BloqueioInterface(nArea:Integer;Ativa:Boolean);                // Atualiza tela
    procedure CarregaTipoRefeicao();                                         // Carrega os dados dos tipos de refeições disponíveis
    procedure InicializaDados(LiberBloq:Boolean;ZeraVotos:Boolean);          // Inicialização dos dados dos restaurantes
    procedure InicializaGrid();                                              // Inicializa informações da tela de resultado
    procedure CarregaDados();                                                // Carrega informações dos restaurantes disponíveis
    procedure CarregaArqIni();                                               // Carrega informações do arquivo Config.ini
...
//    Ender:   Endereço do restaurante vencedor
//    nVotos:  Número de votos do restaurante vencedor
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
// InicializaDados
//    LiberBloq: libera ou não o restaurante para votação
//    ZeraVotos: zera ou não os votos do restaurante
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//  BloqueioInterface
//    nArea:  região da interface que será bloqueada ou liberada
//            1: tela de login
//            2: tela de escolha do restaurante
//            3: tela de visualização do restaurante vencedor
//    Ativa: liberação ou bloqueio da tela
...
////////////////////////////////////////////////////////////////////////////////
//  BloqueiaUsuario
//    Login: login do usuário que será bloqueado
////////////////////////////////////////////////////////////////////////////////
